 ...
 */
class GameCenterLeaderboardSetsGameCenterLeaderboardsGetToManyRelated extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterLeaderboardSets/{$this->id}/gameCenterLeaderboards";
    }
