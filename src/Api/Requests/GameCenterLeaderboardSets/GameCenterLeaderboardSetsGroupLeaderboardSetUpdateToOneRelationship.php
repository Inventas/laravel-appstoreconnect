 ...
 */
class GameCenterLeaderboardSetsGroupLeaderboardSetUpdateToOneRelationship extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        protected string $id,
        protected GameCenterLeaderboardSetGroupLeaderboardSetLinkageRequest $payload,
    ) {}
