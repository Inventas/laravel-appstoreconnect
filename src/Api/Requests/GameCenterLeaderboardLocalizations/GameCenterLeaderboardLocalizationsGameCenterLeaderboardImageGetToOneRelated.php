 ...
 */
class GameCenterLeaderboardLocalizationsGameCenterLeaderboardImageGetToOneRelated extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterLeaderboardLocalizations/{$this->id}/gameCenterLeaderboardImage";
    }
