 ...
 */
class AppClipDefaultExperienceLocalizationsCreateInstance extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/v1/appClipDefaultExperienceLocalizations';
    }

    public function __construct(
        protected AppClipDefaultExperienceLocalizationCreateRequest $payload,
    ) {}
