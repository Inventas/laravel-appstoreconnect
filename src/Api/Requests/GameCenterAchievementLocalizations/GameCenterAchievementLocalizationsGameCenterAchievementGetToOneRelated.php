 ...
 */
class GameCenterAchievementLocalizationsGameCenterAchievementGetToOneRelated extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterAchievementLocalizations/{$this->id}/gameCenterAchievement";
    }
