 ...
 */
class GameCenterAchievementLocalizationsV2CreateInstance extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/v2/gameCenterAchievementLocalizations';
    }

    public function __construct(
        protected GameCenterAchievementLocalizationV2createRequest $payload,
    ) {}
