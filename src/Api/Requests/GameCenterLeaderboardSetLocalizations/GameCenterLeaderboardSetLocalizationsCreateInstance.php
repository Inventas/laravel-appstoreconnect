 ...
 */
class GameCenterLeaderboardSetLocalizationsCreateInstance extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/v1/gameCenterLeaderboardSetLocalizations';
    }

    public function __construct(
        protected GameCenterLeaderboardSetLocalizationCreateRequest $payload,
    ) {}
