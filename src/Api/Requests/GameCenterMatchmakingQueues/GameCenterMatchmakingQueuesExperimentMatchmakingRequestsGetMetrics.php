 ...
 */
class GameCenterMatchmakingQueuesExperimentMatchmakingRequestsGetMetrics extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterMatchmakingQueues/{$this->id}/metrics/experimentMatchmakingRequests";
    }
