 ...
 */
class GameCenterGroupsGameCenterDetailsGetToManyRelated extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterGroups/{$this->id}/gameCenterDetails";
    }
    ...
    public function __construct(
        ...
        protected ?array $filtergameCenterAppVersionsEnabled = null,
        /** @var array<int, string>|null */
    ...
    {
        return array_filter([
            'filter[gameCenterAppVersions.enabled]' => $this->filtergameCenterAppVersionsEnabled,
