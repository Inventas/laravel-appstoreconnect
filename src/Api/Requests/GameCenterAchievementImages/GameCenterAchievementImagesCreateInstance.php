 ...
 */
class GameCenterAchievementImagesCreateInstance extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/v1/gameCenterAchievementImages';
    }

    public function __construct(
        protected GameCenterAchievementImageCreateRequest $payload,
    ) {}
