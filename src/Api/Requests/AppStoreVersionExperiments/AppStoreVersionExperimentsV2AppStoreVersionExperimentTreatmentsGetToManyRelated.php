 ...
 */
class AppStoreVersionExperimentsV2AppStoreVersionExperimentTreatmentsGetToManyRelated extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v2/appStoreVersionExperiments/{$this->id}/appStoreVersionExperimentTreatments";
    }
