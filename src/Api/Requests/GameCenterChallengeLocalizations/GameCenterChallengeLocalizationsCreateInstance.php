 ...
 */
class GameCenterChallengeLocalizationsCreateInstance extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/v1/gameCenterChallengeLocalizations';
    }

    public function __construct(
        protected GameCenterChallengeLocalizationCreateRequest $payload,
    ) {}
