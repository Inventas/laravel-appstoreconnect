 ...
 */
class GameCenterMatchmakingRulesMatchmakingRuleErrorsGetMetrics extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/v1/gameCenterMatchmakingRules/{$this->id}/metrics/matchmakingRuleErrors";
    }
